...
const NEWS_ITEMS: NewsItem[] = [
    {
        ...
        description: "새로운 학기를 맞아 동아리 등록/재등록 기간이 시작되었습니다. 기간 내에 신청서를 제출해주세요.",
        date: "2026.03.02",
        category: "공지사항",
    ...
    },
    {
        ...
        description: "지난 주말 진행된 연합 해커톤의 수상팀을 발표합니다. 참여해주신 모든 분들께 감사드립니다.",
        date: "2026.02.28",
        category: "행사",
    ...
    },
    {
        ...
        description: "2026년도 동아리실 배정 결과가 발표되었습니다. 각 동아리 대표자분들은 확인 부탁드립니다.",
        date: "2026.02.25",
        category: "공지사항",
...
export function NewsSection() {
    ...
    return (
        <Card>
            <CardContent>
                <div className="flex flex-col gap-12 w-full mx-auto px-4 py-2">
                    {/* 섹션 헤더: 제목 및 전체보기 링크 */}
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div className="space-y-1">
                            <h2 className="text-2xl font-bold text-gray-900">동아리 뉴스</h2>
